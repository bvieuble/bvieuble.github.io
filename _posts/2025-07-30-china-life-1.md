...
thumbnail: assets/img/blog/get-nas.png
---
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="/assets/img/blog/get-nas.png" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<h5 style="text-align: center;"> <em> But then, can you still access your NAS from outside your home? </em> </h5>
...
Let's have a little recap of the pros and cons of NAS devices in China:
  ...
  - :x: BUT owning your data means that **you are responsible for implementing the best data security and integrity practices**. It will require time and learning.
